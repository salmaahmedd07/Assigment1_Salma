...
Hero: salma ahmed hassan the Mage
Student ID: 16001631
GitHub account: salmaahmedd07

A **Sand Kraken** bars the way near **the Sinai dunes**. It only falls to
the exact blow.
...
4. Your warcry — copy the line below exactly, including punctuation:
   ...
   "By the Sinai dunes, the Sand Kraken kneels!"
